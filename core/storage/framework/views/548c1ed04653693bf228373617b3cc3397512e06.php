                        ...
                        <?php $__currentLoopData = $add->conversation->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-12">
                                <div class="alert alert-<?php echo e($data->type ==1? 'success':'info'); ?>">
                                    <strong><?php if($data->type == 1): ?><?php echo e($add->from_user->username); ?> <?php else: ?> You <?php endif; ?>
                                        :</strong>
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        <strong>
                            ...
                            to <?php echo e($add->add_type == 2 ? 'sell':'buy'); ?> <?php echo e($add->amount_to); ?> <?php echo e($add->gateway->currency); ?>
                            ...
                            <?php echo e($add->currency->name); ?> <?php echo e($add->add_type == 1? 'from':'to'); ?> you
                            .</strong>
                        <br>
                        <br>
