        ...
        <?php endif; ?>
                    ...
                    <form id="uploadDetail" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <strong><i class="fa fa-comment"></i> Send Message to <a style="color: blue" href="<?php echo e(route('user.profile.view', $add->from_user->username)); ?>"><?php echo e($add->to_user->username); ?> :</a></strong>
                            ...
                            <?php $__currentLoopData = $add->conversation->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-12">
                                    <div class="alert alert-<?php echo e($data->type ==1? 'success':'info'); ?>">
                                        <strong><?php if($data->type == 1): ?><?php echo e($add->from_user->name); ?> <?php else: ?> <?php echo e(Auth::user()->username); ?> <?php endif; ?> :</strong>
            ...
            <div class="col-md-4">
                <div class="alert alert-info">
                    <p>You are <?php echo e($add->add_type == 1 ? 'buying':'selling'); ?> <?php echo e($add->amount); ?> <?php echo e($add->gateway->currency); ?> with <?php echo e($add->amount_to); ?> <?php echo e($add->currency->name); ?> <?php echo e($add->add_type == 2? 'from':'to'); ?> <?php echo e($add->to_user->name); ?> .</p><br>
