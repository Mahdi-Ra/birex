        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="myf1" action="<?php echo e(route('sell.buy')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="gateway_id" id="coin" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $coin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    
                                        <?php if(old('gateway_id') && old('gateway_id') == $data->id): ?>
                                            <option selected="" value="<?php echo e(old('gateway_id')); ?>">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="crypto_id" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if(old('crypto_id') && old('crypto_id') == $data->id): ?>
                                            <option selected="" value="<?php echo e(old('crypto_id')); ?>">
                                                <?php echo e($data->name); ?>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="currency" id="currency" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $currency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if(old('currency') && old('currency') == $data->id): ?>
                                            <option selected="" value="<?php echo e(old('currency')); ?>">
                                                <?php echo e($data->name); ?>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php if(is_numeric(old('margin'))): ?>
                                        <input class="form-control" type="number"  name="margin" value="<?php echo e(old('margin')); ?>" id="margin" placeholder="Margin">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input name="s4" value="<?php echo e(old('s4')); ?>" class="form-control" type="text" id="price" readonly>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <p style="color: gray;">
                                    ...
                                    Your BTC Balance :
                                    <?php echo e(sprintf("%.8f", floor($bal * pow(10, 8)) / pow(10, 8)),round($bal, 8)); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <?php if(session()->has('maxx')): ?>
                                        
                                        <input id="maa" class="form-control" type="text" name="max_amount"
                                               value="<?php echo e(session('maxx')); ?>" placeholder="Max Amount">
                                    <?php session()->forget('maxx'); ?>
                                    <?php else: ?>
                                        <input id="maa" class="form-control" type="text" name="max_amount"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input id="mi" name="s2" class="form-control" type="text"
                                           value="<?php echo old('s2'); ?>" readonly>
                                    <div class="input-group-prepend">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input id="ma" name="s1" class="form-control" type="text"
                                           value="<?php echo old('s1'); ?>" readonly>
                                    <div class="input-group-prepend">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" name="term_detail"
                                          rows="5"><?php echo old('term_detail'); ?></textarea>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change', "#currency", function () {
                ...
                switch(cur)
                {
                    case '1': price = <?php echo e($usd); ?>; document.getElementById("mi_c").innerText=document.getElementById("mi_cc").innerText="USD";
                    document.getElementById("price").value =<?php echo e($usd); ?>;
                    break;
                    case '2': price = <?php echo e($try); ?>; document.getElementById("mi_c").innerText=document.getElementById("mi_cc").innerText="TRY";
                    document.getElementById("price").value =<?php echo e($try); ?>;
                    break;
                    case '3': price = <?php echo e($eur); ?>; document.getElementById("mi_c").innerText=document.getElementById("mi_cc").innerText="EUR"; 
                    document.getElementById("price").value =<?php echo e($eur); ?>;
                    break;
                    default:break;
                }
