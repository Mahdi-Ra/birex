        ...
        <div class="col-md-3">
            <div class="tile">
                ...
                <div class="tile-body">
                    ...
                    <hr>
                    <h5 class="bold">User Name : <?php echo e($user->username); ?></h5>
                    <h5 class="bold">Name : <?php echo e($user->name); ?></h5>
                    <hr>
                    <p>
                        <strong>Last Login : <?php echo e(Carbon\Carbon::parse($user->login_time)->diffForHumans()); ?></strong>
                        <br>
                    </p>
                    <hr>
                    <?php if($last_login != null): ?>

                        <strong>Last Login From</strong> <br> <?php echo e($last_login->user_ip); ?> -  <?php echo e($last_login->location); ?>

                        <br> Using <?php echo e($last_login->details); ?> <br>
        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <a href="<?php echo e(route('user.trans',$user->id)); ?>" class="text-decoration">
                        <div class="widget-small primary coloured-icon"><i class="icon fa fa-th fa-3x"></i>
                            <div class="info">
                                <h6>TRANSACTED</h6>
                                <p><b><?php echo e($trans); ?></b></p>
                            </div>
                        </div>
                    </a>
                </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <a href="<?php echo e(route('user.deposit',$user->id)); ?>" class="text-decoration">
                        <div class="widget-small info coloured-icon">
                            <i class="icon fa fa-download fa-3x"></i>
                            <div class="info">
                                <h6>DEPOSITS</h6>
                                <p><b><?php echo e($deposit); ?></b></p>
                            </div>
                        </div>
                    </a>
                </div>
                <?php $__currentLoopData = $balance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-6 col-lg-6">
                        <div class="widget-small warning coloured-icon">
                            ...
                            <div class="info">
                                <h6><?php echo e($data->gateway->name); ?> Balance:</h6>
                                <p><b>
                                    
                                    <?php echo e(sprintf("%.8f", floor((float)$data->balance  * pow(10, 8)) / pow(10, 8)), round((float)$data->balance , 8)); ?>

                                   
                                <?php echo e($data->gateway->currency); ?></b></p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="<?php echo e(route('user.balance',$user->id)); ?>"
                                       class="btn btn-lg btn-block btn-primary"><i class="fa fa-money"></i>
                                        Add/Substract Balance</a><br>
                                </div>
                                <div class="col-md-6">
                                    <a href="<?php echo e(route('user.login.history',$user->id)); ?>"
                                ...
                                <div class="col-md-6">
                                    <a href="<?php echo e(route('user.email',$user->id)); ?>"
                                       class="btn btn-lg btn-block btn-primary"> <i
                                                class="fa fa-envelope"></i> Send Email & Sms</a>
                                    <br>
                                </div>
                                <div class="col-md-6">
                                ...
                                <table class="table table-striped table-bordered table-hover order-column" id="">
                                    ...
                                    <?php $__currentLoopData = $addvertise; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($data->min_amount.' '.$data->currency->name .'-'. $data->max_amount.' '.$data->currency->name); ?></td>
                ...
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form id="form" method="POST" action="<?php echo e(route('user.status', $user->id)); ?>"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                               ...
                                               name="email_verify" <?php echo e($user->email_verify == "1" ? 'checked' : ''); ?>>
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                               data-offstyle="danger" data-width="100%" data-on="Yes" data-off="No"
                                               type="checkbox" value="1"
                                               name="phone_verify" <?php echo e($user->phone_verify == "1" ? 'checked' : ''); ?>>
                                    </div>
                                </div>
                                <hr/>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">
                            <i class="fa fa-user"></i> Authentication</h3>

                        <div class="tile-body">

                            <form  method="POST" action="<?php echo e(route('admin.userAuth', $user->id)); ?>"
                                  enctype="multipart/form-data" name="editForm">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                                        <label> <strong>Name</strong></label>
                                        <input type="text" name="name" class="form-control input-lg"
                                               value="<?php echo e($user->name); ?>" disabled>
                                        <?php if($errors->has('name')): ?>
                                            <span class="help-block">
                                                <strong><?php echo e($errors->first('name')); ?></strong>
                                            </span>
                                ...
                                <center>
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <h5>User Passport Photo</h5>
                                            <br>


                                        <?php if(file_exists($user->passport_image)): ?>
                                                <img width="326" height="300"
                                                     src="<?php echo e(route('homepage').'/'.$user->passport_image); ?>"/>
                                            <?php else: ?>
                                                <img width="326" height="300" src=" <?php echo e(url('assets/user/images/user-default.png')); ?> " class="img-responsive propic"
                                                     alt="Profile Pic">
                                            <?php endif; ?>
                                            ...
                                            <br>
                                            <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                                   data-offstyle="danger" data-width="100%" data-on="Confirmed" data-off="Unverified"
                                                   type="checkbox" value="1"
                                                   name="passport_image_state" <?php echo e($user->passport_image_state == true ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <h5>Selfie Bircoin Requested Photo </h5>
                                            <br>
                                            <?php if(file_exists($user->selfi_request)): ?>
                                                <img width="326" height="300"
                                            ...
                                            <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                                   data-offstyle="danger" data-width="100%" data-on="Confirmed" data-off="Unverified"
                                                   type="checkbox" value="1"
                                                   name="selfi_request_state" <?php echo e($user->selfi_request_state == true ? 'checked' : ''); ?>>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php if(file_exists($user->selfie_image)): ?>
                                                <img width="326" height="300"
                                                     src="<?php echo e(route('homepage').'/'.$user->selfie_image); ?>"/>
                                            <?php else: ?>
                                                <img width="326" height="300" src=" <?php echo e(url('assets/user/images/user-default.png')); ?> " class="img-responsive propic"
                                                     alt="Profile Pic">
                                            <?php endif; ?>
                                            ...
                                            <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                                   data-offstyle="danger" data-width="100%" data-on="Confirmed" data-off="Unverified"
                                                   type="checkbox" value="1"
                                                   name="selfie_image_state" <?php echo e($user->selfie_image_state == true ? 'checked' : ''); ?>>
                                        </div>



                                        <div class="form-group col-md-6">
                                            <h5>User Custom Photo</h5>
                                            Random Photo Condition :
                                            <p><?php echo e(\App\Cond::find($user->custom_image_cond)->text); ?></p>
                                            <br>
                                           
                                            <?php if(file_exists($user->custom_image)): ?>
                                                <img width="326" height="300"
                                                     src="<?php echo e(route('homepage').'/'.$user->custom_image); ?>"/>
                                            <?php else: ?>
                                                <img width="326" height="300" src=" <?php echo e(url('assets/user/images/user-default.png')); ?> " class="img-responsive propic"
                                                     alt="Profile Pic">
                                            <?php endif; ?>  <br>
                                            ...
                                            <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                                   data-offstyle="danger" data-width="100%" data-on="Confirmed" data-off="Unverified"
                                                   type="checkbox" value="1"
                                                   name="custom_image_state" <?php echo e($user->custom_image_state == true ? 'checked' : ''); ?>>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            <h5>Expert Message</h5>
                                            <textarea  name="expert_message" row="7" class="form-control input-lg" value=""></textarea>
                                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="POST" action="<?php echo e(route('user.passchange', $user->id)); ?>"
