                                        ...
                                        <?php $__currentLoopData = $complaints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-md-12">
                                                <div class="alert alert-info">
                                                    <strong> <?php if($data->from_==Illuminate\Support\Facades\Auth::id()): ?>
                                                            You <?php else: ?> Operator <?php endif; ?></strong>
                                                    ...
                                                    <?php if(!is_null($data->img)): ?>
                                                        <img width="400" height="350" src="https://bircoin.co/assets/images/attach/<?php echo e($data->img); ?>">
                                                    <?php endif; ?>
                                                </div>
                                            </div>
