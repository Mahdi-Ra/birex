            ...
            <div class="tile">
                ...
                <div class="title-body">
                    ...
                    <h5>Name : <?php echo e($user->name); ?></h5>
                            <?php $__currentLoopData = $balance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <h6> <?php echo e($data->gateway->name); ?> BALANCE : <?php echo e(sprintf("%.8f", floor((float)$data->balance  * pow(10, 8)) / pow(10, 8)), round((float)$data->balance , 8)); ?> <?php echo e($data->gateway->currency); ?></h6>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <hr>
