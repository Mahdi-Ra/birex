                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="emailto" class="form-control input-lg" value="<?php echo e($user->email); ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>Name</strong></label>
                                        <input type="text" name="reciver" class="form-control input-lg" value="<?php echo e($user->name); ?>"  readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
