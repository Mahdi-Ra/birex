                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php $__currentLoopData = $crypto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><img style="width: 50px; height: 50px" src="<?php echo e(asset('assets/images/crypto/'.$data->icon)); ?>"> </td>
                                    <td>
                                    ...
                                    <td >
                                        <a href="<?php echo e(route('crypto.edit', $data->id)); ?>" class="btn btn-primary bold uppercase"><i class="fa fa-edit"></i> EDIT</a>
                                    </td>
                                </tr>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" method="post" action="<?php echo e(route('crypto.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
