        ...
        <div class="col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p><strong>Trade Limit : </strong><span><?php echo e($coin->min_amount); ?> - <?php echo e($max); ?> <?php echo e($coin->currency->name); ?></span></p>
                </div>
            </div>
        </div>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroupPrepend2"><?php echo e($coin->currency->name); ?></span>
                                        </div>
                                    </div>
                                </div>
