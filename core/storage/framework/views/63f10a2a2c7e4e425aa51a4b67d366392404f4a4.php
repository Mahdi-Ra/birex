        ...
        <div class="col-md-3 text-center margin-top-pranto">
            <div class="card border-dark">
                ...
                <div class="card-body text-dark">
                    <h6 class="card-title"><?php if($gate->balance == 0): ?> 0.0000 <?php echo e($gate->gateway->currency); ?> <?php else: ?> <?php echo e(round($gate->balance, 8)); ?> <?php echo e($gate->gateway->currency); ?><?php endif; ?></h6>
                </div>
            </div>
        </div>
