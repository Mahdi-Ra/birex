...
//Payment IPN
Route::get('/callback_btc', 'PaymentController@ipnCoinPayBtc1')->name('ipn.coinPay.btc');
...
Route::any('/BuyTether', 'FrontendController@BuyTether')->name('BuyTether');
...
Route::get('/logoutt', 'HomeController@logoutt')->name('logoutt');
...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::middleware(['auth','CheckStatuss'])->group(function () {

        Route::get('/home', 'HomeController@index')->name('home');
        Route::any('/auth-for-use', 'HomeController@auth_for_use')->name('user.auth_for_use');


        Route::middleware(['CheckAuthentication','CheckGoogleAuth'])->group(function () {
            ...
            Route::any('/complaint/{id}', 'HomeController@complaint')->name('complainttransactions');



            Route::any('request_a_payment', 'HomeController@request_a_payment')->name('user.request_a_payment');
            Route::any('request_a_payment_list', 'HomeController@request_a_payment_list')->name('user.request_a_payment_list');
...
//            Route::post('/deposit-confirm/', 'PaymentController@depositConfirm')->name('deposit.confirm');
            Route::post('/deposit-confirm/', 'PaymentController@depositConfirm1')->name('deposit.confirm');
            ...
            Route::get('deal/{id}', 'HomeController@dealView')->name('deal_message');
            ...
            Route::any('trade/rate/{id?}', 'HomeController@trade_rate')->name('trade.rate');
...
Route::group(['prefix' => 'admin_eBt6pQ6YuRrE5DgdSGe4wP'], function () {
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
    ...
    Route::any('/userAuth/{id}', 'AdminController@userAuth')->name('admin.userAuth');

    Route::get('/transactions', 'DepositController@transLog')->name('trans.log');
    Route::get('/transactions/{id}', 'AdminController@withdrawal_request_trx')->name('withdrawal_request_trx');
    Route::any('/income', 'AdminController@income')->name('income');
    ...
    //Deposit
    //Advertising
    Route::any('/deposits/{id?}', 'AdminController@deposits')->name('deposits');
    Route::any('/deposits_delete/{id?}', 'AdminController@deposits_delete')->name('deposits_delete');
    Route::any('/advertising/{id?}', 'AdminController@advertising')->name('admin.advertising');
    Route::get('/advertising/confirm/{id}', 'AdminController@advertising_confirm')->name('admin.advertising.confirm');
    Route::get('/advertising/reject/{id}', 'AdminController@advertising_reject')->name('admin.advertising.reject');
    Route::any('/complaints/{id?}', 'AdminController@complaints')->name('admin.complaints');
    Route::any('/complaints/free/{id}', 'AdminController@complaints_free')->name('admin.complaints.free');
    Route::get('/withdrawal_request', 'AdminController@withdrawal_request')->name('admin.withdrawal_request');
    Route::get('/withdrawal_confirm/{id}', 'AdminController@withdrawal_confirm')->name('admin.withdrawal.confirm');
    Route::get('/request_trusted_sell', 'AdminController@request_trusted_sell')->name('admin.request_trusted_sell');
    ///////////////////////
    ...
    Route::post('/sendmail', 'AdminController@sendemail')->name('send.email');
    ...
    Route::any('new_auth', 'GeneralSettingController@new_auth')->name('users.new.auth');
    Route::any('new_user', 'GeneralSettingController@users_new')->name('users.new');
