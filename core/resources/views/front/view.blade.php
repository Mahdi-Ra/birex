    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <p><strong>Trade Limit : </strong><span>{{$coin->min_amount}} - {{$max}} BTC</span></p>
                    <p><strong>Trade Limit (Price In {{$coin->currency->name}}) : </strong><span>{{$coin->min_amount * $pr}} - {{$max * $pr}} {{$coin->currency->name}}</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card margin-top-pranto">
                <div class="card-body">
                    <br>
                    <button type="button" data-toggle="modal" data-target="#termModal" class="btn btn-dark btn-lg btn-block">{{$coin->user->name}}'s Terms</button><br>
                    <button type="button" data-toggle="modal" data-target="#paymentModal" class="btn btn-secondary btn-lg btn-block">{{$coin->user->name}}'s Payment Detail</button><br>
                </div>
            </div>
        </div>
    </div> <hr>
            ...
            <div class="col-md-8 offset-md-2 col-sm-12 padding-pranto-bottom">
                <div class="login-admin login-admin1">
                    ...
                    <div class="login-form">
                        <a href="{{url('/login')}}" class="btn btn-danger" style="display: block;text-decoration:none">Sign In Now</a>
                    </div>
                    <br>
                    <div class="login-form">
