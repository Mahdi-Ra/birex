    ...
    <div class="row">
        <div class="col-md-12">
            <div class="jumbotron text-center">
                <h1 class="display-4" style="font-weight: bold;color: #212529;">{{$general->banner_title}}</h1>
                <hr class="my-4">
                <p>{{$general->banner_sub_title}}</p>
                @guest
                    <a class="btn btn-primary btn-lg " href="{{url('register')}}" role="button"> <i
                                class="fa fa-check-square-o"></i> Sign Up Now</a>
                @else
                    <a class="btn btn-primary btn-lg " href="{{url('/user/home')}}" role="button"> <i
                ...
                <table class="table">
                    ...
                    @foreach($buy_btc as $data)
                        ...
                        <tr @if($data->min_amount >= $data->max_amount && $data->add_type == 1) style="display: none" @endif>
                            ...
                            <td>@if($data->trusted_sell == 1)
                                    <img src="/trusted_sell.png" width="40" height="40">
                                @endif
                            </td>
                            <td><a href="{{route('view', ['id'=>$data->id, 'payment'=>Replace($data->method->name)])}}"
