        ...
        <div class="col-md-3 text-center margin-top-pranto">
            <div class="card border-dark">
                ...
                <div class="card-body text-dark">
                    <h6 class="card-title">
                        @if($gate->balance == 0) 0.0000 
                            {{$gate->gateway->currency}}
                        @else 
                            {{
                            sprintf("%.8f", floor((float)$gate->balance  * pow(10, 8)) / pow(10, 8)), round((float)$gate->balance , 8)
                            }}
                            {{$gate->gateway->currency}}
                        @endif
                    </h6>
    ...
    <div class="row padding-pranto-top margin-top-pranto padding-pranto-bottom">
        ...
        <div class="col-md-3 text-center margin-top-pranto">
            <div class="card border-dark">
                ...
                <div class="card-body text-dark">
                    <h5 class="card-title">{{App\AdvertiseDeal::where('to_user_id', Auth::id())->orWhere('from_user_id', Auth::id())->where('status', 1)->count()}}</h5>
                </div>
                <div class="card-footer">
