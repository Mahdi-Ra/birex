                        ...
                        <div class="widget-small warning coloured-icon">
                            ...
                            <div class="info">
                                ...
                                <p><b>
                                    ...
                                    {{ 
                                        sprintf("%.8f", floor((float)$data->balance  * pow(10, 8)) / pow(10, 8)), round((float)$data->balance , 8)
                                    }}
                                   
                                {{$data->gateway->currency}}</b></p>
                            </div>
                        </div>
                    </div>
                @endforeach
                ...
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <form  method="POST" action="{{route('admin.userAuth', $user->id)}}"
                                  enctype="multipart/form-data" name="editForm">
                                @csrf
                                ...
                                <center>
                                    <div class="row">
                                        ...
                                        @if(file_exists($user->passport_image))
                                            ...
                                            @else
                                                <img width="326" height="300" src=" {{url('assets/user/images/user-default.png')}} " class="img-responsive propic"
                                                     alt="Profile Pic">
                                            @endif
                                            ...
                                            <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                                   ...
                                                   type="checkbox" value="1"
                                                   name="passport_image_state" {{ $user->passport_image_state == true ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <br>
                                            @if(file_exists($user->selfi_request))
                                                <img width="326" height="300"
                                            ...
                                            <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                                   data-offstyle="danger" data-width="100%" data-on="Confirmed" data-off="Unverified"
                                                   type="checkbox" value="1"
                                                   name="selfi_request_state" {{ $user->selfi_request_state == true ? 'checked' : '' }}>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            @if(file_exists($user->selfie_image))
                                                <img width="326" height="300"
                                                     src="{{route('homepage').'/'.$user->selfie_image}}"/>
                                            @else
                                                <img width="326" height="300" src=" {{url('assets/user/images/user-default.png')}} " class="img-responsive propic"
                                                     alt="Profile Pic">
                                            @endif
                                            ...
                                            <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                                   data-offstyle="danger" data-width="100%" data-on="Confirmed" data-off="Unverified"
                                                   type="checkbox" value="1"
                                                   name="selfie_image_state" {{ $user->selfie_image_state == true ? 'checked' : '' }}>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <p>{{\App\Cond::find($user->custom_image_cond)->text}}</p>
                                            <br>
                                           
                                            @if(file_exists($user->custom_image))
                                                <img width="326" height="300"
                                                     src="{{route('homepage').'/'.$user->custom_image}}"/>
                                            @else
                                                <img width="326" height="300" src=" {{url('assets/user/images/user-default.png')}} " class="img-responsive propic"
                                                     alt="Profile Pic">
                                            @endif  <br>
                                            ...
                                            <input class="form-control" data-toggle="toggle" data-onstyle="success"
                                                   data-offstyle="danger" data-width="100%" data-on="Confirmed" data-off="Unverified"
                                                   type="checkbox" value="1"
                                                   name="custom_image_state" {{ $user->custom_image_state == true ? 'checked' : '' }}>
