                            ...
                            @foreach($addvertise as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{
                                          sprintf("%.8f", floor((float)$data->min_amount  * pow(10, 8)) / pow(10, 8)), round((float)$data->min_amount , 8)
                                    ...
                                    <td>
                                        @if($data->status == -1 && $data->reject==false)
                                            In Pending
                                        @elseif($data->reject)
                                            Rejected
                                    ...
                                    <td><a href="{{route('sell_buy.edit', $data->id)}}"
