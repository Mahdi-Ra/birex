...
Dear user for sending any file you must be add a text.
                            <div class="form-group">
                                <strong><i class="fa fa-comment"></i> Send Message to <a style="color: blue" href="{{route('user.profile.view', $add->to_user->username)}}">{{$add->to_user->username}} :</a></strong>
                            ...
                            @foreach($add->conversation->reverse() as $data)
                                <div class="col-md-12">
                                    <div class="alert alert-{{$data->type ==1? 'success':'info' }}">
                                        <strong>@if($data->type == 1)You @else {{$add->to_user->username}} @endif :</strong>
            ...
            <div class="col-md-4">
                <div class="alert alert-info">
                    <p>You are {{$add->add_type == 1 ? 'buying':'selling' }} 
                    ...
                    {{$add->add_type == 2? 'from':'to' }} {{$add->to_user->name}} .</p><br>
            ...
            <div class="modal-content">
                ...
                <form method="post" action="{{route('confirm.paid.reverse')}}">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="status" value="{{$add->id}}" class="btn btn-primary pull-right">I Have Paid Money</button>
