...
class TicketController extends Controller
{
    ...
    public function adminReply(Request $request, $ticket)
    {
        ...
        $tk = Ticket::where('ticket', $ticket)->first();

        send_email(User::find($tk->customer_id)->email, User::find($tk->customer_id)->name, 'Ticket',
                'Your ticket has been answered');
        send_sms(User::find($tk->customer_id)->phone, 'Your ticket has been answered');
